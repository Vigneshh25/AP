...
public class Main {
    public static void main(String[] args) {
        ...
        FileOperation createFolderOperation = new CreateFolderOperation(root, "Documents");
        ...
        Observer user2Observer = message -> System.out.println("User2 received notification: " + message);
